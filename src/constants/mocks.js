const results = [
  {
    ...
    description: 'To use this navigator, ensure that you have @react-navigation/native and its dependencies (follow ... Pushes a new screen to top of the stack and navigate to it.',
    type: 'article'
  },
  {
    id: '2',
...
const relatedSearches = [
  ...
  'react - navigation - stack github',
  'react - navigation - stack expo',
  'unable to resolve react navigation stack',
  'react - navigation - stack does not exist',
...
const suggestions = [
  ...
  '@react-navigations/stack - npm',
  'react-native-screens and change your imports',
  'To implement the stack navigator in React Native'
];

export { results, suggestions, misc, relatedSearches }